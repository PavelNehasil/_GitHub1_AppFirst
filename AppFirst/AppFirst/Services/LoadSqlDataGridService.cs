...
public class LoadSqlDataGridService : ILoadSqlDataGridService
{
    public string connectionString = string.Empty;

    private ObservableCollection<Order> _allOrders;

    public LoadSqlDataGridService(string connectionString)
    {
    ...
    public async Task<IEnumerable<Order>> GetGridDataAsync()
    {
        ...
        await LoadSqlDataNowAsync(_allOrders);

        await Task.CompletedTask;
        return _allOrders;
    }

    Task<IEnumerable<Order>> ILoadSqlDataGridService.GetContentGridDataAsync()
    {
        throw new NotImplementedException();
    }

    Task<IEnumerable<Order>> ILoadSqlDataGridService.GetListDetailsDataAsync()
    {
        throw new NotImplementedException();
    }
